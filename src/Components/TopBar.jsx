import { Search, ArrowRight, Bell, Settings, User } from "lucide-react";

export default function TopBar({ query, onQueryChange, onSearch, avatarUrl }) {
    ...
    <div className="flex items-center gap-4 px-60 py-5 max-w-8xl">
      ...
      >
        ...
        <input
          ...
          placeholder="Search standards, e.g. Water Purifiers"
          className="flex-1 bg-transparent text-sm text-neutral-800 placeholder:text-neutral-400 focus:outline-none py-1.5"
        />
        <button
          type="submit"
          className="w-8 h-8 shrink-0 flex items-center justify-center rounded-lg bg-[#0d234f] text-white hover:bg-[#0a1c40] transition-colors"
          aria-label="Search"
        >
