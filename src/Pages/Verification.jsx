...
export default function Verification() {
  ...
  const HUID_SAMPLE = {
    is_valid: true,
    huid: "A8F2X9",
    article_type: isHindi
      ? "सोने की अंगूठी / 22K (916)"
      : "Gold Ring / 22K (916)",
    purity: isHindi
      ? "22 कैरेट (91.6% शुद्ध सोना)"
      : "22 Karat (91.6% Pure Gold)",
    metal: isHindi ? "सोना (Gold)" : "Gold",
    jeweller_name: isHindi
      ? "तनिष्क ज्वैलर्स लिमिटेड"
      : "Tanishq Jewellers Ltd.",
    registration_no: "BIS-REG-982341",
    hallmarking_date: "14-Feb-2024",
  ...
  const LICENSE_SAMPLE = {
    ...
    manufacturer_name: isHindi
      ? "हैवेल्स इंडिया लिमिटेड"
      : "Havells India Limited",
    factory_address: isHindi
      ? "हरिद्वार, उत्तराखंड"
      : "Haridwar, Uttarakhand",
    is_standard: "IS 1293:2019",
    product_name: isHindi
      ? "प्लग और सॉकेट-आउटलेट"
      : "Plugs and Socket-Outlets",
    brand: "Havells",
    status: "OPERATIONAL / ACTIVE",
    valid_till: "31-Mar-2027",
    message: isHindi
  ...
  /*
    ...
    We keep the complete response so that
    is_valid is not lost.
  */
  ...
  const isValidResult = (result) => {
    ...
    return (
      ...
      String(result?.status).toLowerCase().includes("verified") ||
      String(result?.status).toLowerCase().includes("operational")
    );
  };
              ...
              {huidResult && (
                <div className="mt-6 border border-emerald-200/80 rounded-2xl p-5 bg-gradient-to-b from-emerald-50/20 to-transparent">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                    ...
                    <DetailItem
                      label={t("huidNumberLabel")}
                      value={
                        huidResult?.data?.huid ||
                        huidResult?.huid ||
                        huid
                      }
                    />
                    ...
                    <DetailItem
                      label={t("jewelleryTypeLabel")}
                      value={displayValue(
                        huidResult?.data?.article_type ||
                        huidResult?.article_type ||
                        huidResult?.data?.jewellery_type ||
                        huidResult?.jewellery_type
                      )}
                    />
                    ...
                    <DetailItem
                      label={t("jewellerLabel")}
                      value={displayValue(
                        huidResult?.data?.jeweller_name ||
                        huidResult?.jeweller_name ||
                        huidResult?.data?.jeweller ||
                        huidResult?.jeweller
                      )}
                    />
                    ...
                    <DetailItem
                      label={t("bisRegLabel")}
                      value={displayValue(
                        huidResult?.data?.registration_no ||
                        huidResult?.registration_no ||
                        huidResult?.data?.registration_number ||
                        huidResult?.registration_number
                      )}
                    />
                    ...
                    <DetailItem
                      ...
                      value={displayValue(
                        huidResult?.data?.hallmarking_date ||
                        huidResult?.hallmarking_date ||
                        huidResult?.data?.verification_date ||
                        huidResult?.verification_date
                      )}
                    />
                ...
                <div className="mt-6 border border-blue-200/80 rounded-2xl p-5 bg-gradient-to-b from-blue-50/20 to-transparent">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                    ...
                    <DetailItem
                      ...
                      value={
                        licenseResult?.data?.license_number ||
                    ...
                    <DetailItem
                      label={t("licenceHolderLabel")}
                      value={displayValue(
                        licenseResult?.data?.manufacturer_name ||
                        licenseResult?.manufacturer_name ||
                        licenseResult?.data?.holder_name ||
                        licenseResult?.holder_name ||
                    ...
                    <DetailItem
                      ...
                      value={displayValue(
                        licenseResult?.data?.product_name ||
                        licenseResult?.product_name ||
                    ...
                    <DetailItem
                      ...
                      value={displayValue(
                        licenseResult?.data?.is_standard ||
                        licenseResult?.is_standard ||
                        licenseResult?.data?.standard ||
                    ...
                    <DetailItem
                      ...
                      value={displayValue(
                        licenseResult?.data?.factory_address ||
                        licenseResult?.factory_address ||
                        licenseResult?.data?.manufacturer_name ||
                        licenseResult?.manufacturer_name ||
                    ...
                    <DetailItem
                      ...
                      value={displayValue(
                        licenseResult?.data?.issue_date ||
                        licenseResult?.issue_date ||
                    ...
                    <DetailItem
                      ...
                      value={displayValue(
                        licenseResult?.data?.valid_till ||
                        licenseResult?.valid_till ||
                        licenseResult?.data?.expiry_date ||
                        licenseResult?.expiry_date ||
...
function VerificationResultHeader({
  valid,
  title,
  t,
}) {
